...
private:
    ...
    SymbolTable* _globalST, *_currentST;
    ...
    inline void addToCurrST();
    inline void addToGlobalST();
    inline void createNewST();
    inline void createNewST(SymbolTable*);
    inline void closeCurrST();

    inline void initSimbolTable();
